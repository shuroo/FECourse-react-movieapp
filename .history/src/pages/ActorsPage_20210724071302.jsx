...
function ActorsPage() {
    ...
    const [actors, setActors] = useState([ new ActorModel("Angelina", "Jolie", new Date("04/06/1975"), "angelinw.jpg", "https://www.imdb.com/name/nm0001401/"),
     new ActorModel("Brad", "Pitt", new Date("04/06/1975"), "brad_pitt.jpg", "https://www.imdb.com/name/nm0000093/"),
     new ActorModel("Angelina", "Jolie", new Date("04/06/1975"), "angeline.jpg", "https://www.imdb.com/name/nm0001401/"),
     new ActorModel("Brad", "Pitt", new Date("04/06/1975"), "brad_pitt.jpg", "https://www.imdb.com/name/nm0000093/"),
     ])
    ...
    let actorsHtml = actors.map(act=> <div><CardComponent actor={act}/></div>)
