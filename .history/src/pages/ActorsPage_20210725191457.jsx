...
import {Button,Row,Container,InputGroupText} from 'react-bootstrap';
    ...
    return (
        <div >
            ...
            <Container>
             ...
             <InputGroupText value={filterText} onChange={(e)=>filterTextByEvent(e)}   placeholder="Filter Actors!"></InputGroupText>
