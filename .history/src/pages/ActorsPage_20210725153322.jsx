...
import {Button,Form,Row,Container,InputGroup} from 'react-bootstrap';
...
function ActorsPage() {
    ...
    return (
        <div >
            <h2>Actors Page</h2>
            <Container>
            <InputGroup.text  type="text" value={filterText} onChange={(e)=>filterTextByEvent(e)}   placeholder="Filter Actors!"></InputGroup.text>
