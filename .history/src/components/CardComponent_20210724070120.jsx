...
<div className=" card col col-md-4 col-lg-4 col-sm-4" onClick={()=>(alert())}>
 {actor.image}
  <img className="actorImg card-img-top" src="/home/shiris/Desktop/FECourse2021/exercises/React/createReactApp/MovieApp/movieapp/src/pages/angeline.jpg" alt={actor.firstName+" "+actor.lastName}/>
